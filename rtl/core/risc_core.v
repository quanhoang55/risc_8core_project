...
module risc_core #(
    ...
    wire mem_wb_can_forward =
        mem_wb_valid && mem_wb_reg_write && (mem_wb_rd_addr != 5'd0);
    ...
    always @(*) begin
        ...
        else if (mem_wb_can_forward && (mem_wb_rd_addr == id_ex_rs1_addr)) begin
        ...
        else if (mem_wb_can_forward && (mem_wb_rd_addr == id_ex_rs2_addr)) begin
    ...
    always @(*) begin
        ...
        else if (id_ex_valid && id_ex_branch && branch_condition_met) begin
            redirect_taken  = 1'b1;
    ...
    always @(posedge clk or posedge reset) begin
        if (reset) begin
            ...
            if (mem_wait) begin
                ...
                else if (ex_mem_mem_read || ex_mem_mem_lr || ex_mem_mem_amo) begin
