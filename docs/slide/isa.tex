...
\subsection{Tập lệnh cơ bản RV32I}
\begin{frame}{Tổng quan Tập lệnh RISC-V (RV32I)}
...
\begin{frame}{Đặc trưng kỹ thuật RV32I}
    \begin{columns}
...
\begin{frame}{6 Kiểu định dạng lệnh cơ bản}
    \begin{columns}
...
\subsection{Tập lệnh hiện thực trong dự án}
\begin{frame}{Tập lệnh hiện thực trong dự án}
    \begin{columns}
